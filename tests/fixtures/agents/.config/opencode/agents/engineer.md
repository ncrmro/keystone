---
description: "Keystone archetype agent for engineer. Use when you want this role without impersonating a specific OS agent."
mode: subagent
---

# Keystone Archetype Agent: engineer
