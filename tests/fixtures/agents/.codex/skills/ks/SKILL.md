---
name: ks
description: "Keystone assistant — may start keystone_system/issue or keystone_system/doctor"
---
...
- Capabilities: ks, project, engineer, product, project-manager
- Development mode: disabled
- Published commands: ks, ks.projects, ks.engineer, ks.product, ks.pm
...
Use this skill when the user invokes `$ks` or asks for this workflow implicitly.
