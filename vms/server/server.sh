#!/usr/bin/env bash
/nix/store/1a4qf3ahlxjz2zpmd00psfymhf4yviqn-qemu-9.2.4/bin/qemu-system-x86_64 \
    ...
    -drive if=pflash,format=raw,unit=0,file=/nix/store/bjngl1dxcmjgn52gpx2hh8g5qg9pbm68-OVMF-202411-fd/FV/OVMF_CODE.fd,readonly=on \
