...
let
  ...
  hasBackups =
    currentHostEntry != null
    && currentHostEntry.zfs != null
    && currentHostEntry.zfs.backups != { };
      ...
      mkCommands =
        ...
        concatMap (
          ...
          let
            ...
            sshTarget =
              if targetHost.sshTarget != null then targetHost.sshTarget else targetHost.hostname;
      ...
      assertions =
        ...
        (optionals hasBackups (
          map (
            ...
            in
            {
              assertion = hasAttr parsed.hostKey hosts;
        ...
        map (
          ...
          nameValuePair "${senderHostname}-sync" {
            ...
            openssh.authorizedKeys.keys =
              optional (backup != null && backup.senderPublicKey != null) backup.senderPublicKey;
          }
