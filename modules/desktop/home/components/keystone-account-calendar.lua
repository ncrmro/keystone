Name = "keystone-account-calendar"
NamePretty = "Calendars"
Description = "Configured calendars"
...
function GetEntries()
    local handle = io.popen(command_path("keystone-accounts-menu") .. " calendars-json 2>/dev/null")
    if not handle then
        return {}
    end
