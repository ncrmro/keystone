...
- **project/onboard** — onboard a new project: create project profile and link repos
...
- Mentions of health audit, repo conventions, or release post coverage → `project/doctor`
